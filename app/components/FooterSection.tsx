      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-5 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <img
              className="h-10"
              src="/logo/SafeGuard.png"
              alt="SafeGuard"
            />
            <p className="text-gray-300 text-base">
              Making the world safer, one community at a time.
            </p>
            <div className="flex space-x-6">
              <a href="#" onClick={handleLinkClick} className="text-gray-400 hover:text-gray-300">
              ...
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  {footerLinks.resources.map((item) => (
                    <li key={item.name}>
                      <a href={item.href} onClick={handleLinkClick} className="text-base text-gray-300 hover:text-white">
                        {item.name}
                      </a>
                    </li>
                  ))}
